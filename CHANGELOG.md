...
- 任务列表：分页（12/页）、行序号、按文件名/插件/作者/状态等搜索。
- 产物版本库：分页（7/页）、行序号、按插件/作者/版本/架构等搜索；多选下载与全选保持跨页有效。

## [0.2.3] - 2026-09-04

- 品牌文案改为“Dify 插件离线重打包工具”。
- 界面视觉重设计：清爽蓝色调、柔光渐变背景/卡片阴影、蓝色主按钮、分区化信息层级，整体去模板化。

## [0.2.2] - 2026-09-04

- 产物版本库支持**多选下载**：行内勾选/全选（跨刷新保持选择），“下载所选”打包为 zip（条目以 job-id 前缀防重名）；空选与无效任务返回 404。
